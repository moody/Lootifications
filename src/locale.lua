...
L["LOOT_PRICES_TOOLTIP"] = "Include the vendor price for looted items."
L["MAX_NOTIFICATIONS_TEXT"] = "Max Notifications"
L["MAX_NOTIFICATIONS_TOOLTIP"] = "Set the maximum number of displayed notifications."
L["MONEY_NOTIFICATIONS_TEXT"] = "Money Notifications"
L["MONEY_NOTIFICATIONS_TOOLTIP"] = "Notify when money is looted or received."
L["NOTIFICATION_ALPHA_TEXT"] = "Notification Alpha"
L["NOTIFICATION_ALPHA_TOOLTIP"] = "Set notification background transparency."
L["NOTIFICATION_FADE_OUT_DELAY_TEXT"] = "Notification Fade-Out Delay"
L["NOTIFICATION_FADE_OUT_DELAY_TOOLTIP"] = "Set the delay time before notifications fade out."
L["NOTIFICATION_SPACING_TEXT"] = "Notification Spacing"
L["NOTIFICATION_SPACING_TOOLTIP"] = "Set the amount of spacing between displayed notifications."
L["OPTIONS_TEXT"] = "Options"
L["OWNED_ITEM_COUNTS_TEXT"] = "Owned Item Counts"
L["OWNED_ITEM_COUNTS_TOOLTIP"] = "Include the owned count of looted items."
